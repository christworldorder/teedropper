  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-8 text-gray-300 leading-relaxed">
        <section>
          <h2 className="text-xl font-black uppercase tracking-tight text-yellow-400 mb-3">All Sales Final</h2>
        ...
        <section>
          <h2 className="text-xl font-black uppercase tracking-tight text-yellow-400 mb-3">We Made a Mistake?</h2>
          <p>If your item arrives defective, damaged, misprinted, or is the wrong item entirely, we will make it right. Email us at <a href="mailto:teedropper@proton.me" className="underline hover:text-yellow-500">teedropper@proton.me</a> within 14 days of delivery with your order number and a photo. We will send a replacement at no cost to you.</p>
        </section>
